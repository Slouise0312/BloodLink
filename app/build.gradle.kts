...
android {
    ...
    defaultConfig {
        applicationId = "com.company.bloodlink"
        minSdk = 26
        targetSdk = 35
        versionCode = 1
        versionName = "1.0"
    ...
    // Required: prevent TFLite model files from being compressed in the APK
    androidResources {
        noCompress += "tflite"
    }
...
dependencies {
    ...
    // CameraX for capture (optional; can use existing camera intent)
    implementation("androidx.camera:camera-camera2:1.3.1")
    implementation("androidx.camera:camera-lifecycle:1.3.1")
    implementation("androidx.camera:camera-view:1.3.1")
    // QR code generation (for screening ID)
